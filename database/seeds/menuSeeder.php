...
class menuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menues = array(
            ...
            ['id_menu' => 1,'modulo' => 4,'status' => 1,'codigo' => 'invp13','nombre' => 'Gestion de Costos Standard','descripcion' => 'Adiciona, modifica registros tabla costos standard','url' => 'gestion-costo-standard','estado' => 'ACTIVO'],
