...
class menuSeeder extends Seeder
{
    public function run()
    {
        ...
        $menues = array(
            ...
            ['id_menu' => 1,'modulo' => 2,'status' => 1,'codigo' => 'emp9','nombre' => 'gestion de tipo de localidades','descripcion' => 'menu de gestion de la empresa','url' => 'gestion-tipo-localidades','estado' => 'ACTIVO'],
