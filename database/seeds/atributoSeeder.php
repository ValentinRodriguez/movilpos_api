    ...
    public function run()
    {
        $codigos = array(
            ...
            [   'id_atributo' => 3,
                'descripcion' => 'memoria',
                'tipo' => 'select',
                'atributo' => '[{ "label" : "128 m", "value":false },
                                { "label" : "<128 m", "value":false },
                                { "label" : "≤ 512 MB", "value":false },
                                { "label" : "1 GB", "value":false },
                                { "label" : "2 GB", "value":false },
                                { "label" : "3 GB", "value":false },
                                { "label" : "4 GB", "value":false },
                                { "label" : "6 GB", "value":false },
                                { "label" : "8 GB", "value":false },
                                { "label" : "10 GB", "value":false },
                                { "label" : "12 GB", "value":false }
                                ]'
            ],
            [   'id_atributo' => 4,
